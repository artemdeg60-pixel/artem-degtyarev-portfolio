...
export const aboutParagraphs = [
  "Сейчас моя роль связана с координацией операционных и проектных процессов в сети магазинов и ломбардов «Золотой Стандарт». В работе я отвечаю за распределение задач, контроль сроков и качества, координацию команды, улучшение процессов и достижение результата по ключевым показателям.",
  "Переход в проектное управление для меня логичен: в операционной роли я всё больше занимался именно координацией людей, структурированием процессов, внедрением изменений и управлением результатом через систему, а не через ручной контроль.",
  "Моя сильная сторона — превращать разрозненные задачи в понятный порядок: цели, роли, сроки, договорённости, артефакты и контрольные точки. Дальше хочу развиваться в digital-проектах полного цикла, где бизнес-задача соединяется с продуктом, командой и технологической реализацией.",
];
