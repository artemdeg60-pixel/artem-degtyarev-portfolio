...
export const aboutParagraphs = [
  "Выполняю задачи по координации людей, выстраиванию процессов, контролю сроков, внедрению изменений и достижению результата через систему, а не только через ручное управление.",
  "Владею Jira, Notion, Miro, MS Project, Excel, Bitrix24, 1С, понимаю основы SDLC и работаю с Agile/Scrum, Kanban, Waterfall, Lean, WBS, RACI, roadmap, User Story, CJM и JTBD. Развитые soft skills: сильная коммуникация, лидерство, управление стейкхолдерами, командная работа, адаптивность, критическое мышление, решение проблем, управление конфликтами, ответственность за результат и умение работать в условиях изменений.",
];
...
export const education = [
  "Саратовский национальный исследовательский государственный университет имени Н.Г. Чернышевского, Институт физики, «Управление качеством»",
  "Академия гражданской защиты МЧС России, «Информационные системы и технологии (инженер)»",
